🥐 Miguitas Pastelería Artesanal - Brandbook

Bienvenido al repositorio del Manual de Identidad Visual de Miguitas. Este proyecto consiste en un manual de marca interactivo de una sola página (Single Page Application) construido con tecnologías web modernas, diseñado específicamente para ser visualizado en el navegador y exportado a formato PDF en un tamaño exacto A4.
...
El documento está estrictamente configurado para ajustarse a una hoja tamaño A4 (210mm x 297mm). El código CSS incluye reglas específicas (.page) y utilidades @media print que eliminan las sombras, ocultan los botones de la interfaz y resetean los márgenes del navegador para garantizar una impresión perfecta y profesional que no corta el contenido.
...
Para que el documento se renderice correctamente, los siguientes archivos de imagen deben estar en el mismo directorio que el .html:

logo-sinfondo.jpg (Logo principal de la portada)

miguita-sinfondo.jpg (Mascota aislada)

miguita-roll-sinfondo.jpg (Mascota en acción)

miguita-roll-dulce-sinfondo.jpg (Variación del producto)
